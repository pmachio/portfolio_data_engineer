...
public final class InfluxDbReporter extends ScheduledReporter {
    ...
    public static class Builder {
        ...
        //TODO Ir metiendo segun corresponda
...
*/
    ...
    public void report(
        ...
        try {
            ...
            testFields.put("TestMetricts", 0);
            influxDb.writePointMeasument("TestMetric", now, testFields);
    ...
    private void reportGaugeGroup(String name, Map<String, Gauge> gaugeGroup, long now) {
        ...
        if (!fields.isEmpty()) {
            influxDb.writePointMeasument(name, now, fields);
        }
